...
class CustomUser(AbstractUser):
    ...
    licence_issued_by = models.ForeignKey('master.DistrictMaster', on_delete=models.SET_NULL, null=True, blank=True,related_name='licence_district')
    visa_issued_by = models.ForeignKey('master.DistrictMaster', on_delete=models.SET_NULL, null=True, blank=True,related_name='user_district')
    visa_no = models.CharField(max_length=50, null=True, blank=True)
    visa_expiry = models.DateTimeField( null=True, blank=True)
    districts_id_no = models.CharField(max_length=50, null=True, blank=True)
    districts_expiry = models.DateTimeField(null=True, blank=True)
...
class Customers(models.Model):
    ...
    district = models.ForeignKey('master.DistrictMaster', on_delete=models.SET_NULL, null=True, blank=False)
