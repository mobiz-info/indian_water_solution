...
urlpatterns = [
    ...
    path('load_route_salesman/', load_route_salesman, name='load_route_salesman'),
    ...
    path('missing-customers/excel/',views.missing_customers_excel,name='missing_customers_excel'),
