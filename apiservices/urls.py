...
from . views import *
from . import views
from .views import GetAppPermissionsAPI
...
urlpatterns = [
    ...
    path('update-customer-rate/<str:customer_id>/', UpdateCustomerRateAPIView.as_view(), name='update-customer-rate'),
    ...
    path('app-permissions/', GetAppPermissionsAPI.as_view(), name='get-app-permissions'),
