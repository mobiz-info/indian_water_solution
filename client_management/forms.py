...
class CustomerSupplyForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['grand_total','discount','net_payable','vat','subtotal','amount_recieved','collected_empty_bottle','allocate_bottle_to_free','allocate_bottle_to_custody','allocate_bottle_to_paid','reference_number','supply_date']
