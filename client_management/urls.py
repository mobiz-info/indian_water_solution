...
#------------------------------Report-------------------------
        ...
        path('custody-issue/print/', print_custody_issue_view, name='print_custody_issue'),
        path('custody-issue/excel/', custody_issue_excel, name='custody_issue_excel'),
        path('customer_custody_items/<uuid:customer_id>/', get_customercustody, name='customer_custody_items'),
        path('custody/return/<uuid:customer_id>/',custody_item_return,name='custody_item_return'),
        ...
        path("delete_invoice_outstanding/<path:invoice_no>/<uuid:customer_pk>/", delete_invoice_outstanding, name="delete_invoice_outstanding"),

        # Customer count
        path('customer_count', customer_count, name="customer_count"),
        path('customer-count/excel/', customer_count_excel, name='customer_count_excel'),
        path('customer-count/print/',print_customer_count_view,name='print_customer_count'),
        ...
        re_path(r'^customer_transaction_list_excel/$', customer_transaction_list_excel, name='customer_transaction_list_excel'),
        ...
        path("customer-outstanding-report-excel/", customer_outstanding_report_excel, name="customer_outstanding_report_excel"),
