...
class CustomerCouponForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            'created_date','payment_type','amount_recieved','grand_total','discount','net_amount','total_payeble','balance','reference_number','coupon_method','invoice_no',
        ]
        widgets = {
            'created_date': forms.DateInput(format='%Y-%m-%d', attrs={'class': 'form-control', 'type': 'date'}),
