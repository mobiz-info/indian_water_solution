...
from van_management.models import Van_Routes, VanCouponStock
from . models import *
from .forms import  *
...
def delete_coupon_recharge(request, pk):
    ...
    try:
        with transaction.atomic():
            ...
            ChequeCouponPayment.objects.filter(customer_coupon=coupon_recharge).delete()
...
def route_wise_coupon_report(request):
    ...
    if start_date:
        ...
        filters_issue['staff_Orders_details_id__staff_order_id__order_date__gte'] = start_date

    if end_date:
        filters_sale['customer_coupon__created_date__date__lte'] = end_date
        filters_issue['staff_Orders_details_id__staff_order_id__order_date__lte'] = end_date
