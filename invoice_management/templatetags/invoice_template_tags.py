...
def get_total_values(queryset):
    ...
    net_taxable = queryset.aggregate(total_net_taxable=Sum('amount_before_vat'))['total_net_taxable'] or 0
    vat = queryset.aggregate(total_vat=Sum('vat_amount'))['total_vat'] or 0
