...
#------------------Product-Route wise sales report
    ...
    path('product_route_salesreport', product_route_salesreport, name='product_route_salesreport'),
    path("product-route-salesreport/detail/",product_route_salesreport_detail,name="product_route_salesreport_details"),
    path("product-route-salesreport/invoice/",product_route_salesreport_invoice_detail,name="product_route_salesreport_invoice_detail"),
...
#------------------DSR Total Sales Report-------------------------------------
    path('total_sales_report',total_sales_report, name='total_sales_report'),
    path('total_sales_report_excel',total_sales_report_excel, name='total_sales_report_excel'),
...
#-------------------DSR coupon Sales-------------------------
    ...
    path('dsr_coupon_sales_excel',dsr_coupon_sales_excel, name='dsr_coupon_sales_excel'),
    path('delete_coupon_sale/<uuid:sale_id>/', delete_coupon_sale, name='delete_coupon_sale'),
...
#-------------------DSR coupon Book  Sales-------------------------
    ...
    path('coupon_book_sale_delete/<uuid:pk>/', coupon_book_sale_delete, name='coupon_book_sale_delete'),
    path('coupon_book_sale_change_date/<uuid:pk>/', coupon_book_sale_change_date, name='coupon_book_sale_change_date'),
...
#-------------------DSR FOC Customers-------------------------
    ...
    path('dsr_foc_customers_excel',dsr_foc_customers_excel, name='dsr_foc_customers_excel'),   
...
#------------------DSR Stock Report-------------------------------------
    ...
    path('dsr_stock_report_excel',dsr_stock_report_excel, name='dsr_stock_report_excel'),
#------------------dsr_expense----------------
    path('dsr_expense',dsr_expense, name='dsr_expense'),
    path('dsr_expense_print',dsr_expense_print, name='dsr_expense_print'),
    path('dsr_expense_excel',dsr_expense_excel, name='dsr_expense_excel'),
    ...
    path('dsr_five_gallon_rates_excel',dsr_five_gallon_rates_excel, name='dsr_five_gallon_rates_excel'),
    path('five_gallon_rates_report', five_gallon_rates_report, name='five_gallon_rates_report'),
    path('five_gallon_rates_report_print', five_gallon_rates_report_print, name='five_gallon_rates_report_print'),
    path('five_gallon_rates_report_excel', five_gallon_rates_report_excel, name='five_gallon_rates_report_excel'),
    ...
    path('dsr_credit_outstanding_excel',dsr_credit_outstanding_excel, name='dsr_credit_outstanding_excel'),
...
#------------------DSR Visit Statistics Report-------------------------------------
    ...
    path('outstanding_amount_collected_excel',outstanding_amount_collected_excel, name='outstanding_amount_collected_excel'),
    ...
    path('collection_list_excel/', collection_list_excel, name='collection_list_excel'),
    ...
    path('monthly_sales_report_excel/', monthly_sales_report_excel, name='monthly_sales_report_excel'),
    
    path('route_sales_report/', detailed_sales_report, name='route_sales_report'),
    path('route_sales_report_excel/', detailed_sales_report_excel, name='route_sales_report_excel'),
    ...
    path('monthly_outstanding_report/', monthly_outstanding_report, name='monthly_outstanding_report'),
    
    # Customer Bottle Report
    path('customer-bottle-report/', customer_bottle_report, name='customer_bottle_report'),
    path('customer-bottle-report/<uuid:route_id>/', customer_bottle_route_detail, name='customer_bottle_route_detail'),
    path("customer_price_history_report/", customer_price_history_report, name="customer_price_history_report"),
    path("customer_price_history_report/excel/", customer_price_history_report_excel, name="customer_price_history_report_excel"),
    
    # Detailed Delivery Report
    path('detailed-delivery-report/', detailed_delivery_report, name='detailed_delivery_report'),
    path('detailed-delivery-report-print/', detailed_delivery_report_print, name='detailed_delivery_report_print'),
    path('detailed-delivery-report-excel/', detailed_delivery_report_excel, name='detailed_delivery_report_excel'),
]